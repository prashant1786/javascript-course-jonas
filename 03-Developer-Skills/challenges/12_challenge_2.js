...
//   return total;
// }
// function averageDaily(arr) {
//   return totalHours(arr) / arr.length;
// }
// function dayWithMax(arr) {
//   let max = 0;
//   let day;
//   for (let index = 0; index < arr.length; index++) {
//     if (arr[index] > max) {
...
//   return days;
// }
// function isFullTime(arr) {
//   return totalHours(arr) >= 35;
// }
// let arr = [7.5, 8, 6.5, 0, 8.5, 4, 0];
// console.log(totalHours(arr));
// console.log(averageDaily(arr));
// console.log(dayWithMax(arr));
// console.log(noOfDays(arr));
// console.log(isFullTime(arr));
